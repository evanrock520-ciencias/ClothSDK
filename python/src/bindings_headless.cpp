    ...
    py::class_<ClothMesh, std::shared_ptr<Tissu::ClothMesh>>(m, "ClothMesh")
        ...
        .def(
            ...
            [](ClothMesh& self, int rows, int cols, double spacing,
               Cloth& out_cloth, Solver& solver, Eigen::Vector3d translation,
               Eigen::Vector4d rotation) {
                Eigen::Quaterniond quat(rotation[3], rotation[0], rotation[1],
                                        rotation[2]);
        ...
        .def(
            ...
            [](ClothMesh& self, const std::vector<Eigen::Vector3d>& positions,
               ...
               Eigen::Vector3d translation, Eigen::Vector4d rotation) {
                Eigen::Quaterniond quat(rotation[3], rotation[0], rotation[1],
                                        rotation[2]);
