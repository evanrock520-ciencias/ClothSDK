...
PYBIND11_MODULE(_cloth_sdk_core, m) {
  ...
  py::class_<Tissu::ClothMaterial, std::shared_ptr<Tissu::ClothMaterial>>(
      ...
      .def_property("bending_compliance", &ClothMaterial::getBendingCompliance,
  ...
  py::class_<DistanceConstraint, Constraint,
      ...
      .def(py::init<int, int, double, double>(), py::arg("idA"), py::arg("idB"),
           py::arg("restLength"), py::arg("compliance"));

  py::class_<BendingConstraint, Constraint, std::unique_ptr<BendingConstraint>>(
      m, "BendingConstraint")
  ...
  py::class_<VolumeConstraint, Constraint, std::unique_ptr<VolumeConstraint>>(
      m, "VolumeConstraint")
      .def(py::init<const std::vector<Triangle>&, const std::vector<Particle>&,
                    double>(),
  ...
  py::class_<Tissu::Viewer::Renderer, std::unique_ptr<Tissu::Viewer::Renderer>>(
      m, "Renderer")
