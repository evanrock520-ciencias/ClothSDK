...
> [!NOTE]
> To see more about the python API, check the [Python API documentation](../python/index.md).

## Running Tests

Tissu includes a comprehensive test suite for both C++ and Python. They're powered by Google Test and Pytest,
respectively.
I recommend using the provided Python utility script to run the tests.
...
To maintain code consistency, Tissu incorporates code style checks using `clang-format` for C++ and `ruff` for Python.
To check the code style, before committing your changes, run the following commands:
