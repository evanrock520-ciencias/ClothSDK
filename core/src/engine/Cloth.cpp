...
void Cloth::setGridDimensions(int rows, int cols) {
    m_gridCols = cols;
    m_gridRows = rows;
}
void Cloth::setTopology(ClothTopology topology) {
    m_topology = topology;
}

void Cloth::addParticleId(int id) {
    m_particleIndices.push_back(id);
}
void Cloth::addTriangle(const Triangle& tri) {
