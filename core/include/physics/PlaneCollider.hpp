 ...
 *
 * This collider defines a half-space using an origin point and a constant
 * normal vector. It is typically used for floors, walls, or static flat
 * surfaces. Particles penetrating the plane are projected back to the surface
